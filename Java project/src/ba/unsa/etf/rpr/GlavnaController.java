...
public class GlavnaController {
    ...
    public void actionDodajGrad(ActionEvent actionEvent) {
        ...
        try {
            ...
            GradController gradController = new GradController(null, dao.drzave(), dao.regije());
    ...
    public void actionIzmijeniGrad(ActionEvent actionEvent) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/grad.fxml"));
            GradController gradController = new GradController(grad, dao.drzave(), dao.regije());
            loader.setController(gradController);
            root = loader.load();
            stage.setTitle("Grad");
            stage.setScene(new Scene(root, USE_COMPUTED_SIZE, USE_COMPUTED_SIZE));
    ...
    public void actionDodajRegiju(ActionEvent actionEvent) {
        Stage stage = new Stage();
        Parent root = null;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/regija.fxml"));
            RegijaController regijaController = new RegijaController(null);
            loader.setController(regijaController);
            root = loader.load();
            ...
            stage.setOnHiding(event -> {
                Regija regija = regijaController.getRegija();
                if (regija != null) {

                    try {
                        dao.dodajRegiju(regija);
